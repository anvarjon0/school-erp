  ...
  <div class="space-y-6 max-w-5xl mx-auto pb-10">
    ...
    <div class="flex items-center justify-between">
      <div class="flex items-center space-x-4">
        ...
        <div>
          <h1 class="text-2xl font-bold text-gray-900 dark:text-white tracking-tight">O'quvchi Qo'shish</h1>
          <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Yangi o'quvchini ro'yxatdan o'tkazish formasi</p>
        </div>
      </div>
      <button 
        @click="submitForm"
      ...
      <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
        ...
        <div class="p-6">
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div>
              <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Qabul qilingan sana <span class="text-red-500">*</span></label>
            ...
            <div>
              <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Sinf (Daraja) <span class="text-red-500">*</span></label>
            ...
            <div>
              <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Guruh (Harf) <span class="text-red-500">*</span></label>
